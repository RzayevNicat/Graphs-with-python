...
def is_connected(adjacency_matrix):
    ...
    # Əgər qraf əlaqəli dirsə, True, əks halda False qaytarır
...
# Qrafın əlaqəli olub olmamasını yoxlamaq üçün funksiyanı çağırmaq
if is_connected(adjacency_matrix):
    print("Qraf əlaqəlidir.")
else:
    print("Qraf əlaqəli deyil.")